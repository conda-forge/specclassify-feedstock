...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/specclassify-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10895&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/specclassify-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `specclassify` can be installed with:

```
conda install specclassify
```

It is possible to list all of the versions of `specclassify` available on your platform with:
