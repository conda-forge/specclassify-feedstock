...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/specclassify-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/specclassify-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add specclassify
# for installing globally
pixi global install specclassify
```
...
It is possible to list all of the versions of `specclassify` available on your platform:
...
```
pixi search specclassify --channel conda-forge
```
